...
static const cvarTable_t cvarTable[] = {
	...
	{ &cg_thirdPersonSlide, "cg_thirdPersonSlide", "0", CVAR_ARCHIVE },
	{ &cg_thirdPersonRange, "cg_thirdPersonRange", "500", CVAR_ARCHIVE },
	...
	{ &cg_rainbowBlood, "cg_rainbowBlood", "0", 0 }
};
